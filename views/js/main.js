...
var pizzaElementGenerator = function(i) {
  ...
  pizzaContainer.style.height = "330px";
...
// rearranged code content to read more like a book. That is, up to down. First we read what size 
// the label is at, then adjust the sizes of the pizzas. I know var newwidth controls how fast/slow
// the pizza image changes, but could not figure out how to make this faster. Calling document. on every
// line impacted speed negatively, somewhat, but removing most of the references with variables helped
...
//Generates the sliding pizzas when the page loads. Changed number of pizzas from 200 to 48.
// Pizzas are now aligned by window width and height. This looks better on all screens and doesn't 
// waste fps for images that can't be seen on mobile devices.
...
function createPizzas(){
  ...
  var rows = Math.floor(windowHeight / 300);
